...
def main():
    ...
    # Variable to stroe the message to be sent to the server
    seed_message = ''

    # Iterate through the random numbers generated by 'generator' for 'seed_increment * CHALLENGE_ROUNDS' times. This is done to prepare the next number to be compared to the user-transmitted seed_value.
